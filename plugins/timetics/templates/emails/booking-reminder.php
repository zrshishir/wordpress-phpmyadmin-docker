...
<main class="email-wrapper">
    ...
    <div class="email-content">
        ...
        <p><?php esc_attr_e( "I hope this email finds you well. This is just a friendly reminder that you have a reservation with us on {$date} at {$time}. We are looking forward to welcoming you to {$this->meeting->name}.", 'timetics' );?></p>
        <p>
        ...
        <span><?php esc_html_e( 'Jonning Link', 'timetics' ); ?><a href="<?php echo esc_url( $join_link ); ?>"><?php echo esc_html( $join_link ); ?></a></span>
        <?php endif;?>
        <p>
