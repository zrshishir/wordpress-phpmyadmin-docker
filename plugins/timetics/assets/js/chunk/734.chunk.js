"use strict";
(self["webpackChunktimetics"] = self["webpackChunktimetics"] || []).push([[734],{
...
// EXTERNAL MODULE: ./assets/src/admin/pages/meeting/hook/useMeetings.js + 1 modules
var useMeetings = __webpack_require__(714);
...
/* harmony export */ });
/* harmony import */ var _admin_actionCreators_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3632);
/* harmony import */ var _admin_context_provider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7258);
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
...
function useRequestConfig() {
  var _useStateValue = (0,_admin_context_provider__WEBPACK_IMPORTED_MODULE_1__/* .useStateValue */ .K)(),
    _useStateValue2 = _slicedToArray(_useStateValue, 2),
    meeting = _useStateValue2[0].meeting,
    dispatch = _useStateValue2[1];
  var per_page = meeting.per_page,
    paged = meeting.paged;
  var getRequestConfig = function getRequestConfig(_ref) {
    var _ref$method = _ref.method,
      method = _ref$method === void 0 ? "GET" : _ref$method,
      _ref$_per_page = _ref._per_page,
      _per_page = _ref$_per_page === void 0 ? per_page : _ref$_per_page,
      _ref$_paged = _ref._paged,
      _paged = _ref$_paged === void 0 ? paged : _ref$_paged;
    return {
      method: method,
      params: {
        per_page: _per_page,
  ...
  var setRequestConfig = function setRequestConfig(_ref2) {
    var _ref2$per_page = _ref2.per_page,
      per_page = _ref2$per_page === void 0 ? per_page : _ref2$per_page,
      _ref2$paged = _ref2.paged,
      paged = _ref2$paged === void 0 ? paged : _ref2$paged;
    dispatch({
      type: _admin_actionCreators_actions__WEBPACK_IMPORTED_MODULE_0__/* .actions.SET_PAGINGATE_DATA */ .N.SET_PAGINGATE_DATA,
      payload: {
        per_page: per_page,
        paged: paged
      }
  ...
  var clearRequestConfig = function clearRequestConfig() {
    dispatch({
      type: _admin_actionCreators_actions__WEBPACK_IMPORTED_MODULE_0__/* .actions.SET_PAGINGATE_DATA */ .N.SET_PAGINGATE_DATA,
      payload: {
        per_page: 10,
  ...
  return {
    ...
    clearRequestConfig: clearRequestConfig
  };
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (useRequestConfig);
